...
private:
   ...
   {  // SETUP
      ...
      assertEquals(pos.x, 99.9);
      assertEquals(pos.y, 99.9);
   ...
   {  // SETUP
      ...
      // VERIFY
      assertEquals(z, 123.4);
      assertEquals(pos1.x, 99.9);
      assertEquals(pos1.y, 99.9);
      assertEquals(pos1.metersFromPixels, 123.4);
      assertEquals(pos2.x, 88.8);
      assertEquals(pos2.y, 88.8);
   ...
   void setMetersX()
   {  // setup
      double metersFromPixels = Position::metersFromPixels; // temporarily stores old value
      Position::metersFromPixels = 99.9;
      Position pos;
      pos.x = 999.9;
      pos.y = 888.8;
   ...
   {  // setup
      ...
      pos.y = 888.8;
      pos.metersFromPixels = 1.0;
      double xPixels = 123.4;

      // exercise
      pos.setPixelsX(xPixels);
   ...
   {  // setup
      ...
      pos.y = 888.8;
      pos.metersFromPixels = 1.0;
      double yPixels = 123.4;

      // exercise
      pos.setPixelsY(yPixels);

      // verify
      assertEquals(pos.x, 999.9);
      assertEquals(pos.y, 123.4);
      assertEquals(pos.metersFromPixels, 1.0);
      assertEquals(yPixels, 123.4);
   ...
   {  // SETUP
      ...
      double xMeters = 123.4;

      // EXERCISE
      pos.addMetersX(xMeters);

      // VERIFY
      assertEquals(pos.x, 4623.4);
      assertEquals(pos.y, 2500.0);
      assertEquals(xMeters, 123.4);
      assertEquals(pos.metersFromPixels, 99.9);
   ...
   {  // SETUP
      ...
      pos.y = 2500.0;
      pos.metersFromPixels = 99.9;
      double yMeters = 123.4;

      // EXERCISE
      pos.addMetersY(yMeters);

      // VERIFY
      assertEquals(pos.x, 4500.0);
      assertEquals(pos.y, 2623.4);
      assertEquals(yMeters, 123.4);
      assertEquals(pos.metersFromPixels, 99.9);
      assertEquals(Position::metersFromPixels, 99.9);
   ...
   {  // SETUP
      ...
      // EXERCISE
      pos.addPixelsX(xPixels);

      // VERIFY
      assertEquals(pos.x, 4503.0);
      assertEquals(pos.y, 2500.0);
      assertEquals(xPixels, 3.0);
      assertEquals(pos.metersFromPixels, 1.0);
      assertEquals(Position::metersFromPixels, 1.0);
   ...
   {  // SETUP
      ...
      // EXERCISE
      pos.addPixelsY(yPixels);

      // VERIFY
      assertEquals(pos.x, 4500.0);
      assertEquals(pos.y, 2503.0);
      assertEquals(yPixels, 3.0);
      assertEquals(pos.metersFromPixels, 1.0);
      assertEquals(Position::metersFromPixels, 1.0);
   ...
   {  // setup
      ...
      // verify
      assertEquals(pos.x, 4500.0);
      assertEquals(pos.y, 2650.0); // 2650 == 2500 + (50 * 3)
      assertEquals(yPixels, 3.0);
      assertEquals(pos.metersFromPixels, 50.0);
      assertEquals(Position::metersFromPixels, 50.0);
   ...
   {  // setup
      ...
      assertEquals(pos2.metersFromPixels, 123.4);
      assertEquals(pos2.x, 0.0);
      assertEquals(pos2.y, 0.0);
      assertEquals(Position::metersFromPixels, 123.4);
      assertEquals(z, 123.4);
